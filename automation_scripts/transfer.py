...
#
# This makes use of the Globus-hosted native app "MyGroup Archive_Tranfer".
# 
...
# then deleting it.
#
# It requires two command line arguments to function:
...
# Source is the Guest Collection "MyGroup Active Transfer Directory"
# This guest collection corrsponds to directory /storage/group/xyz123/default/INPUT

source_collection_id = "a7b0d0fe-f0ef-4186-a96b-fc89ee61679a" 

# Destination is the Guest Collection "MyGroup Archive Transfer Directory"
# This guest collection corresponds to directory /storage/archive/xyz123/default/OUTPUT

dest_collection_id = "e3a52e0a-b824-4d4b-9b04-1dad86e54c07"

# My client ID - "MyGroup Archive Transfer" native app
...
my_file_adapter = SimpleJSONFileAdapter(
    os.path.expanduser("/storage/home/xyz123/mytokens/my-svc-acct-globus-groups-tokens.json")
)
